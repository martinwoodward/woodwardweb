...
import Video from "../../layouts/shortcodes/Video.tsx";
...
<PrimerHeading level={1} size="display">
  Display Size Primer Heading
</PrimerHeading>

<PrimerHeading level={2} size="1">
  Size 1 Primer Heading
</PrimerHeading>

<PrimerHeading level={3} size="2">
  Size 2 Primer Heading
</PrimerHeading>

<PrimerHeading level={4} size="3">
  Size 3 Primer Heading
</PrimerHeading>

### Primer Text

<PrimerText size="600" weight="semibold">
  This is large, semibold text using Primer React.
</PrimerText>
...
<PrimerText size="300" weight="light" variant="muted">
  This is smaller, lighter, muted text using Primer React.
</PrimerText>
...
<Youtube client:load id="dQw4w9WgXcQ" title="Youtube Video Test Title" />
